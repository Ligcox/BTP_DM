...
#比赛类型设置   0为红方，1为蓝方
categoryDefault = {
    0: [20, 20, 205, 150, 240, 20],
    1: [90, 20, 205, 150, 240, 20]
}
...
channel_filter_controls = {
    ...
    'hueTolerance'	:		[TYPE_CONTROL_NUMERIC, categoryDefault[CATEGOTY_DEFAULT_TYPE][1], [0, 40, 1]],
    'saturationTarget'	:	[TYPE_CONTROL_NUMERIC, categoryDefault[CATEGOTY_DEFAULT_TYPE][2], [0, 255, 1]],
    'saturationTolerance':	[TYPE_CONTROL_NUMERIC, categoryDefault[CATEGOTY_DEFAULT_TYPE][3], [0, 150, 1]],
    'valueTarget'		:	[TYPE_CONTROL_NUMERIC, categoryDefault[CATEGOTY_DEFAULT_TYPE][4], [0, 255, 1]],
    'valueTolerance'	:	[TYPE_CONTROL_NUMERIC, categoryDefault[CATEGOTY_DEFAULT_TYPE][5], [0, 150, 1]],
...
energy_filter_controls = {
    ...
    "threshold": [TYPE_CONTROL_NUMERIC, 250, [0, 250, 1]],
    "aug":[TYPE_CONTROL_NUMERIC, 0, [0, 20, 1]],
    "iterations": [TYPE_CONTROL_NUMERIC, 1, [0, 20, 1]],
    'lowHue':[TYPE_CONTROL_NUMERIC, 0, [0, 255, 1]],
    'highHue':[TYPE_CONTROL_NUMERIC, 0, [0, 255, 1]],
    'lowSat':[TYPE_CONTROL_NUMERIC, 0, [0, 255, 1]],
    'highSat':[TYPE_CONTROL_NUMERIC, 255, [0, 255, 1]],
    'lowVal':[TYPE_CONTROL_NUMERIC, 0, [0, 255, 1]],
    'highVal':[TYPE_CONTROL_NUMERIC, 255, [0, 255, 1]],
}
...
energy_detector_controls = {
    "area_lower_value": [TYPE_CONTROL_NUMERIC, 1200, [0, 10000, 1]],
    "area_upper_value": [TYPE_CONTROL_NUMERIC, 2400, [0, 10000, 1]],

    "area_lower_value1": [TYPE_CONTROL_NUMERIC, 60, [0, 10000, 1]],

    "area_upper_value1": [TYPE_CONTROL_NUMERIC, 200, [0, 10000, 1]],

    "Dilate_value": [TYPE_CONTROL_NUMERIC, 17, [0, 40, 1]],
...
# decision控制集
decision_controls = {
    'yaw_angle_offset':   [TYPE_CONTROL_NUMERIC, 0, [-5, 5, 0.01]],
    'pitch_angle_offset':   [TYPE_CONTROL_NUMERIC, 0, [-5, 5, 0.01]],
}

# 哨兵上云台decision控制集
sentryUp_decision_controls = {
    'yaw_angle_offset':   [TYPE_CONTROL_NUMERIC, 2.84, [-10, 10, 0.01]],
    'pitch_angle_offset':   [TYPE_CONTROL_NUMERIC, 0.3, [-10, 10, 0.01]],
...
sentryDown_decision_controls = {
    ...
    'pitch_angle_offset':   [TYPE_CONTROL_NUMERIC, 0.5, [-10, 10, 0.01]],
    "pitch_pnp_error":   [TYPE_CONTROL_NUMERIC, 0.28, [0, 0.5, 0.01]]
}

hero_decision_controls = {
    'yaw_angle_offset':   [TYPE_CONTROL_NUMERIC, 2.73, [-10, 10, 0.01]],
    'pitch_angle_offset':   [TYPE_CONTROL_NUMERIC, 3.55, [-10, 10, 0.01]],
